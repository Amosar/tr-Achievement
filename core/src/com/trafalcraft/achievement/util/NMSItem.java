...
public class NMSItem {
        ...
        public static ItemStack setNewEntityTag(ItemStack itemStack, String entityType) {
                try {
                        ...
                        Object rootTag = Class.forName("net.minecraft.server." + version + ".NBTTagCompound")
                                .newInstance();
                        Object nbtEntityTag = Class.forName("net.minecraft.server." + version + ".NBTTagCompound")
                                .newInstance();

                        Object nmsItemStack = craftItemStack.getMethod("asNMSCopy", ItemStack.class)
                                .invoke(craftItemStack, itemStack);
                        nbtEntityTag.getClass().getMethod("setString", String.class, String.class)
                                .invoke(nbtEntityTag, "id", entityType);
                        ...
                        System.out.println(
                                nmsItemStack + ">" + craftItemStack.getMethod("asBukkitCopy", nmsItemStack.getClass())
